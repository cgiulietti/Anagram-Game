 ...
 * words out of the letters, and score one point for each letter used. The submissions must be "real words":
 * WordDictionary is used to check each submission.
 * <p/>
 * For example:
 ...
 * <p/>
 * Assumption: no worries about whitespace, special characters, or uppercase.
 */
public interface AnagramGame {
     ...
     * submitted in the constructor, and if it is in the WordDictionary.
     * <p/>
